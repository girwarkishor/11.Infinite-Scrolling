...
},{"core-js-pure/stable/instance/concat":"../node_modules/core-js-pure/stable/instance/concat.js"}],"../node_modules/core-js-pure/internals/to-absolute-index.js":[function(require,module,exports) {
var toInteger = require('../internals/to-integer');
...
},{"../internals/descriptors":"../node_modules/core-js-pure/internals/descriptors.js","../internals/fails":"../node_modules/core-js-pure/internals/fails.js","../internals/has":"../node_modules/core-js-pure/internals/has.js"}],"../node_modules/core-js-pure/modules/es.array.index-of.js":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
...
},{"core-js-pure/stable/instance/index-of":"../node_modules/core-js-pure/stable/instance/index-of.js"}],"../node_modules/core-js-pure/internals/add-to-unscopables.js":[function(require,module,exports) {
...
},{"core-js-pure/stable/instance/for-each":"../node_modules/core-js-pure/stable/instance/for-each.js"}],"../node_modules/core-js-pure/modules/web.timers.js":[function(require,module,exports) {
...
function _getPosts() {
  _getPosts = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var _context;
    ...
    return _regenerator.default.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch((0, _concat.default)(_context = "https://jsonplaceholder.typicode.com/posts?_limit=".concat(limit, "&_page=")).call(_context, page));
...
function _showPosts() {
  _showPosts = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
    var posts;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            //   console.log(posts);
            (0, _forEach.default)(posts).call(posts, function (post) {
              var _context3, _context4;

              var postEl = document.createElement('div');
              postEl.classList.add('post');
              postEl.innerHTML = (0, _concat.default)(_context3 = (0, _concat.default)(_context4 = "\n        <div class=\"number\">".concat(post.id, "</div>\n        <div class\"post-info\">\n            <h2 class=\"post-title\">")).call(_context4, post.title, "</h2>\n            <p class=\"post-body\">")).call(_context3, post.body, "</div>\n        </div>\n    ");
...
function filterPosts(e) {
  ...
  (0, _forEach.default)(posts).call(posts, function (post) {
    ...
    if ((0, _indexOf.default)(title).call(title, term) > -1 || (0, _indexOf.default)(body).call(body, term) > -1) {
...
},{"@babel/runtime-corejs3/regenerator":"../node_modules/@babel/runtime-corejs3/regenerator/index.js","@babel/runtime-corejs3/core-js-stable/instance/concat":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/concat.js","@babel/runtime-corejs3/core-js-stable/instance/index-of":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/index-of.js","@babel/runtime-corejs3/core-js-stable/instance/for-each":"../node_modules/@babel/runtime-corejs3/core-js-stable/instance/for-each.js","@babel/runtime-corejs3/core-js-stable/set-timeout":"../node_modules/@babel/runtime-corejs3/core-js-stable/set-timeout.js","@babel/runtime-corejs3/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs3/helpers/asyncToGenerator.js","./scss/main.scss":"../src/scss/main.scss"}],"C:/Users/girwa/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
